...
var StoreProvider = function (_Component) {
  ...
  _createClass(StoreProvider, [{
    ...
    value: function adapterFor(modelName) {
      return (0, _adapters.fetchAdapter)(this.state.adapters, modelName, this.state);
    }
  }, {
    key: 'modelFor',
    value: function modelFor(modelName, data) {
      return (0, _models.fetchModel)(this.state.models, modelName, this.state, data);
    }
  }, {
    key: 'serializerFor',
    value: function serializerFor(modelName, data) {
      return (0, _serializers.fetchSerializer)(this.state.serializers, modelName, this.state, data);
    }
...
function fetchModel(models, modelName, store) {
	var data = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
...
exports.fetchSerializer = undefined;
...
function fetchSerializer(serializers, modelName, store) {
	...
	return Serializer ? new Serializer(store, data) : new _baseSerializer2.default(store, data);
}

exports.fetchSerializer = fetchSerializer;
...
var BaseSerializer = function () {
	...
	_createClass(BaseSerializer, [{
		...
		value: function serialize(data) {
			var formattedData = this.serializeAttrs(data);
			(0, _helpers.logger)('formattedData: ', formattedData);
		...
		value: function serializeAttrs(data) {
			...
			Object.keys(data).forEach(function (key) {
				formattedData[(0, _transforms.camelToDash)(key)] = _this.serializeAttr(data, key);
			});
