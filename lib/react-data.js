...
var _axiosService = __webpack_require__(/*! services/axios-service */ "./src/services/axios-service.jsx");

var _axiosService2 = _interopRequireDefault(_axiosService);
	...
	_createClass(BaseAdapter, null, [{
		...
		value: function formattedParams() {
			...
			Object.keys(params).forEach(function (p) {
				if (!(0, _helpers.isEmpty)(params[p])) {
		...
		value: function urlForQuery(modelName) {
			var resource = (0, _pluralize2.default)(modelName);
			return this.buildURL(resource);
		}
	}, {
		key: 'urlForQueryRecord',
		value: function urlForQueryRecord(modelName) {
			var id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

			var resource = (0, _pluralize2.default)(modelName);
			var resourceID = id ? id.toString() : null;
		...
		value: function urlForUpdateRecord(modelName) {
			var id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
		...
		value: function urlForDestroyRecord(modelName) {
			var id = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
		...
		key: 'query',
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(modelName, params) {
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								_context.next = 5;
								return this.axios.get(url, { params: formattedParams });
		...
		key: 'queryRecord',
		value: function () {
			var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(modelName) {
		...
		// Methods
		get: function get() {
			return new _axiosService2.default({ baseURL: this.apiDomain, token: this.token }).instance;
		}
	}]);
...
exports.withStore = exports.StoreProvider = exports.StoreContext = undefined;
...
var _adapters = __webpack_require__(/*! helpers/adapters */ "./src/helpers/adapters.jsx");

var _models = __webpack_require__(/*! helpers/models */ "./src/helpers/models.jsx");

var _serializers = __webpack_require__(/*! helpers/serializers */ "./src/helpers/serializers.jsx");

var _jsonApiError = __webpack_require__(/*! utils/json-api-error */ "./src/utils/json-api-error.jsx");

var _jsonApiError2 = _interopRequireDefault(_jsonApiError);
...
var StoreProvider = function (_Component) {
  _inherits(StoreProvider, _Component);

  function StoreProvider(props) {
    _classCallCheck(this, StoreProvider);

    var _this = _possibleConstructorReturn(this, (StoreProvider.__proto__ || Object.getPrototypeOf(StoreProvider)).call(this, props));
    ...
    _this.state = {
      ...
      adapterFor: _this.adapterFor.bind(_this),
      modelFor: _this.modelFor.bind(_this),
      serializerFor: _this.serializerFor.bind(_this),
      createRecord: _this.createRecord.bind(_this),
      updateAll: _this.updateAll.bind(_this),
      updateRecord: _this.updateRecord.bind(_this),
      pushAll: _this.pushAll.bind(_this),
      pushRecord: _this.pushRecord.bind(_this),
      peekAll: _this.peekAll.bind(_this),
      peekRecord: _this.peekRecord.bind(_this),
      peekOrCreateRecord: _this.peekOrCreateRecord.bind(_this),
      removeAll: _this.removeAll.bind(_this),
      removeRecord: _this.removeRecord.bind(_this),
      findAll: _this.findAll.bind(_this),
      findRecord: _this.findRecord.bind(_this),
      query: _this.query.bind(_this),
      queryRecord: _this.queryRecord.bind(_this)
    };
    return _this;
  }
  ...
  _createClass(StoreProvider, [{
    ...
    value: function componentDidMount() {
      (0, _helpers.logger)('React Data initiated...');
      this.adapterFor('').apiDomain = this.state.apiDomain;
      (0, _helpers.logger)('React Data connected to:', this.state.apiDomain);
    }
    ...
    value: function adapterFor(modelName) {
      return (0, _adapters.adapterFor)(this.state.adapters, modelName);
    }
  }, {
    key: 'modelFor',
    value: function modelFor(modelName, data) {
      return (0, _models.modelFor)(this.state.models, modelName, this.state, data);
    }
  }, {
    key: 'serializerFor',
    value: function serializerFor(modelName, data) {
      return (0, _serializers.serializerFor)(this.state.serializers, modelName, this.state);
    }
    ...
    value: function createRecord(modelName, data) {
      ...
      this.setState(_defineProperty({}, modelName, storeRecords), function () {
        return isNew && (0, _helpers.logger)('Store: ', _this2.state);
      });
      return storeRecord;
    }
  }, {
    ...
    value: function updateAll(modelName) {
      ...
      var storeRecords = this.peekAll(modelName);
      this.setState(_defineProperty({}, modelName, storeRecords));
      (0, _helpers.logger)('Store: ', this.state);
    }
  }, {
    key: 'updateRecord',
    ...
    value: function pushAll(modelName, records) {
      ...
      return records.map(function (record) {
        return _this3.pushRecord(modelName, record);
      });
    }
  }, {
    key: 'pushRecord',
    ...
    value: function removeRecord(modelName) {
      ...
      var storeRecord = record.id ? this.peekRecord(modelName, record.id) : storeRecords.find(function (model) {
        return (0, _helpers.isEmpty)(model.id);
      });
      storeRecords = (0, _helpers.removeObject)(storeRecords, storeRecord);
      this.setState(_defineProperty({}, modelName, storeRecords), function () {
        return (0, _helpers.logger)('Store: ', _this4.state);
      });
      return null;
    }
  }, {
    ...
    value: function removeAll(modelName, records) {
      ...
      this.setState(this.state, function () {
        return (0, _helpers.logger)('Store: ', _this5.state);
      });
      return null;
    }
  }, {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if ((0, _helpers.isEmpty)(storeRecords)) {
                  _context.next = 3;
                  break;
                }
    ...
    key: 'findRecord',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(modelName, recordId, params) {
        var storeRecord;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if ((0, _helpers.isEmpty)(storeRecord)) {
                  _context2.next = 3;
                  break;
                }
      ...
      function findRecord(_x5, _x6, _x7) {
        return _ref2.apply(this, arguments);
      }
    ...
    key: 'query',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(modelName, params) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                throw _jsonApiError2.default.format(_context3.t0);
    ...
    key: 'queryRecord',
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(modelName, recordId, params) {
        var response, record;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 8:
                ...
                throw _jsonApiError2.default.format(_context4.t0);
      ...
      function queryRecord(_x10, _x11, _x12) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (context) {
            return _react2.default.createElement(WrappedFunction, _extends({ store: context }, _this7.props));
          }
        );
      }
    }]);
...
exports.adapterFor = undefined;

var _baseAdapter = __webpack_require__(/*! adapters/base-adapter */ "./src/adapters/base-adapter.jsx");

var _baseAdapter2 = _interopRequireDefault(_baseAdapter);

var _transforms = __webpack_require__(/*! utils/transforms */ "./src/utils/transforms.jsx");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function adapterFor(adapters, modelName) {
	var Adapter = adapters[(0, _transforms.dashToCapital)(modelName)];
	return Adapter ? Adapter : _baseAdapter2.default;
}
...
exports.modelFor = undefined;

var _baseModel = __webpack_require__(/*! models/base-model */ "./src/models/base-model.jsx");
...
function modelFor(models, modelName, store) {
	...
	var Model = models[(0, _transforms.dashToCapital)(modelName)];
	return Model ? new Model(modelName, store, data) : new _baseModel2.default(modelName, store, data);
}
...
exports.serializerFor = undefined;

var _baseSerializer = __webpack_require__(/*! serializers/base-serializer */ "./src/serializers/base-serializer.jsx");
...
function serializerFor(serializers, modelName, store) {
	var Serializer = serializers[(0, _transforms.dashToCapital)(modelName)];
	return Serializer ? new Serializer(store) : new _baseSerializer2.default(store);
}
...
exports.JsonApiError = exports.BaseModel = exports.BaseSerializer = exports.BaseAdapter = exports.withStore = exports.StoreProvider = exports.StoreContext = undefined;

var _storeContext = __webpack_require__(/*! contexts/store-context */ "./src/contexts/store-context.jsx");
...
exports.StoreProvider = _storeContext.StoreProvider;
exports.withStore = _storeContext.withStore;
exports.BaseAdapter = _baseAdapter2.default;
exports.BaseSerializer = _baseSerializer2.default;
exports.BaseModel = _baseModel2.default;
exports.JsonApiError = _jsonApiError2.default;
...
var BaseModel = function () {
	function BaseModel(type, store) {
		...
		this.id = props.id || '';
		this.type = (0, _transforms.camelToDash)(type).toLowerCase();
		this.store = store || {};
	...
	_createClass(BaseModel, [{
		...
		value: function pushProp(prop, value) {
			(0, _helpers.addObject)(this[prop], value);
			(0, _helpers.logger)('Store: ', this.store);
		}
	}, {
		key: 'removeProp',
		value: function removeProp(prop, value) {
			(0, _helpers.removeObject)(this[prop], value);
			(0, _helpers.logger)('Store: ', this.store);
		}
	}, {
		key: 'setRelation',
		value: function setRelation(relation, value) {
			return !(0, _helpers.isEmpty)(this[relation]) ? this.set(relation, value) : this.set(relation, this.store.createRecord(relation, value));
		}
	}, {
		key: 'pushRelation',
		value: function pushRelation(relation, value) {
			(0, _helpers.addObject)(this[relation], value);
			(0, _helpers.logger)('Store: ', this.store);
		}
	}, {
		key: 'removeRelation',
		value: function removeRelation(relation, value) {
			(0, _helpers.removeObject)(this[relation], value);
			(0, _helpers.logger)('Store: ', this.store);
		}
	}, {
		key: 'belongsTo',
		value: function belongsTo(modelName) {
			...
			return !(0, _helpers.isEmpty)(data.id) ? this.store.peekOrCreateRecord(modelName, data) : data;
		}
	}, {
		key: 'hasMany',
		value: function hasMany(modelName) {
			...
			return !(0, _helpers.isEmpty)(data.map(function (item) {
				return item.id;
			})) ? data.map(function (item) {
				return _this2.store.peekOrCreateRecord(_pluralize2.default.singular(modelName), item);
			}) : data;
		}
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 11:
								...
								formattedResponse = this.store.serializerFor(this.type).normalize(response.data, response.included, response.meta);
							...
							case 17:
								...
								throw _jsonApiError2.default.format(_context.t1);
		...
		value: function () {
			var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data) {
				var adapter, axios, url, response;
				return regeneratorRuntime.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								adapter = this.store.adapterFor(this.type);
								axios = new _axiosService2.default({ baseURL: adapter.apiDomain, token: adapter.token }).instance;
		...
		value: function () {
			var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(data) {
				var adapter, url, axios, response;
				return regeneratorRuntime.wrap(function _callee3$(_context3) {
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
		...
		value: function () {
			var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
				var adapter, axios, url, response, formattedResponse;
				return regeneratorRuntime.wrap(function _callee4$(_context4) {
					while (1) {
						switch (_context4.prev = _context4.next) {
							case 0:
...
var BaseSerializer = function () {
	...
	_createClass(BaseSerializer, [{
		...
		value: function serialize(data) {
			...
			(0, _helpers.logger)('serializedData: ', serializedData);
		...
		value: function serializeAttrs(data) {
			...
			Object.keys(data).forEach(function (key) {
				...
				if (attr) {
					serializedAttrs[(0, _transforms.camelToDash)(key)] = attr;
				}
			});
		...
		value: function serializeAttr(data, key) {
			if ((0, _helpers.isEmpty)(data[key])) {
				return;
			}
		...
		value: function normalizeArray() {
			...
			(0, _helpers.logger)('normalizedData: ', normalizedData);
		...
		value: function normalizeMeta(meta) {
			...
			Object.keys(meta).forEach(function (key) {
				normalizedMeta[(0, _transforms.dashToCamel)(key)] = parseInt(meta[key]);
			});
			(0, _helpers.logger)('normalizedMeta: ', normalizedMeta);
		...
		value: function normalizeAttrs(data) {
			...
			Object.keys(data).forEach(function (key) {
				if (_typeof(data[key]) == 'object') {
					...
					return normalizedAttrs[(0, _transforms.dashToCamel)(key)] = _this4.normalizeAttrs(data[key], key);
				}
				return normalizedAttrs[(0, _transforms.dashToCamel)(key)] = _this4.normalizeAttr(data, key);
			});
		...
		value: function normalizeRelationships(data, included) {
			...
			Object.keys(data).forEach(function (key) {
				...
				if ((0, _helpers.isEmpty)(relationshipData)) {
					return;
				}

				if (Array.isArray(relationshipData)) {
					return formattedRelationships[(0, _transforms.dashToCamel)(key)] = relationshipData.map(function (relationship) {
						return _this5.normalizeRelationship(relationship, included);
					});
				}
				if ((typeof relationshipData === 'undefined' ? 'undefined' : _typeof(relationshipData)) == 'object') {
					return formattedRelationships[(0, _transforms.dashToCamel)(key)] = _this5.normalizeRelationship(relationshipData, included);
				}
				return formattedRelationships[(0, _transforms.dashToCamel)(key)] = _this5.normalizeRelationship(relationshipData, included);
			});
		...
		value: function normalizeRelationship(relationship, included) {
			...
			return !(0, _helpers.isEmpty)(include) ? this.normalizeAttrs(include) : {};
		}
	}, {
		key: 'attrs',
		get: function get() {
...
var AxiosService = function () {
  ...
  _createClass(AxiosService, [{
    key: 'instance',
    get: function get() {
      var instance = _axios2.default.create({ baseURL: this.baseURL });
      if (this.token) {
...
exports.isEmpty = exports.logger = exports.timer = exports.removeObject = exports.addObject = undefined;
...
var removeObject = exports.removeObject = function removeObject(array, record) {
	return _array2.default.pull(array, record);
};

var timer = exports.timer = function timer(start) {
...
var JsonApiError = function () {
  ...
  _createClass(JsonApiError, null, [{
    key: 'format',
    value: function format(e) {
      try {
        if (e.response) {
          (0, _helpers.logger)('Server error: ', e.response.data.errors);
          return this.formatErrors(e.response.data.errors);
        }
        if (e.request) {
          (0, _helpers.logger)('Request error: ', e.request);
          return [this.formatError(500, 'Request Error', e)];
        }
        (0, _helpers.logger)('App error: ', e);
...
var camelToUnderscore = exports.camelToUnderscore = function camelToUnderscore(key) {
  return key.replace(/([A-Z])/g, "_$1").toLowerCase();
};

var camelToDash = exports.camelToDash = function camelToDash(key) {
  return key.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase();
};

var dashToCamel = exports.dashToCamel = function dashToCamel(key) {
  return key.replace(/-([a-z])/g, function (g) {
    return g[1].toUpperCase();
  });
};

var dashToCapital = exports.dashToCapital = function dashToCapital(key) {
  return key.split('-').map(function (key) {
    return key.replace(key.charAt(0), key.charAt(0).toUpperCase());
  }).join('');
};

var underscoreToCamel = exports.underscoreToCamel = function underscoreToCamel(key) {
  return key.replace(/_([a-z])/g, function (g) {
    return g[1].toUpperCase();
  });
};

var phoneToString = exports.phoneToString = function phoneToString(data) {
