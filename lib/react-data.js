...
var StoreProvider = function (_Component) {
  ...
  function StoreProvider(props) {
    ...
    (0, _adapters.adapterFor)(_this.props.adapters, '').set('apiDomain', _this.props.apiDomain);
    _this.state = {
  ...
  _createClass(StoreProvider, [{
    ...
    value: function componentDidMount() {
      (0, _helpers.logger)('React Data: ', this.state);
    ...
    value: function createRecord(modelName, data) {
      ...
      this.setState(_defineProperty({}, modelName, storeRecords), function () {
        return isNew && (0, _helpers.logger)('React Data: ', _this2.state);
      });
      return storeRecord;
    }
  }, {
    ...
    value: function updateAll(modelName) {
      ...
      var storeRecords = this.peekAll(modelName);
      this.setState(_defineProperty({}, modelName, storeRecords), function () {
        return (0, _helpers.logger)('React Data: ', _this3.state);
      });
    }
  }, {
    key: 'updateRecord',
    ...
    value: function removeRecord(modelName) {
      ...
      this.setState(_defineProperty({}, modelName, storeRecords), function () {
        return (0, _helpers.logger)('React Data: ', _this5.state);
      });
      return null;
    }
  }, {
    ...
    value: function removeAll(modelName, records) {
      ...
      this.setState(this.state, function () {
        return (0, _helpers.logger)('React Data: ', _this6.state);
      });
      return null;
    }
  }, {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (context) {
            return _react2.default.createElement(WrappedFunction, _extends({ store: context }, _this8.props));
          }
        );
      }
    }]);
